<div class=" h-full flex flex-col p-5 bg-black text-white rounded-lg shadow-md">
    <h2 class="font-bold text-2xl  mb-5">Crie uma senha</h2>
    <form class="flex flex-col gap-4 text-white" id="formConfirCode">
        ...
        <button id="btn_createuser" class="w-full h-12 border-2 border-[#9e9e9e] bg-[#9e9e9e]/50 flex justify-center items-center rounded-2xl" type="button">Criar conta</button>
    </form>
    <div>
        @if (session('message'))
            <p>{{session('message')}}</p>
